...
4. По умолчанию проект настроен так, что в итоге вы будете наблюдать графики для **трёх** нод. Если вы хотите больше или меньше трёх нод ([подробно в шаге 1](#шаг-1-terraform-и-openstack)) то придется корректировать графики в grafana самостоятельно.
